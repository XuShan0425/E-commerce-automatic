...
This skill helps you discover and install skills from the open Claude Code skills ecosystem.
...
- Expresses interest in extending Claude Code capabilities
- Wants to search for tools, templates, or workflows
- Mentions they wish they had help with a specific domain (design, testing, deployment, etc.)

## What is the Skills CLI?

The Skills CLI (`npx skills`) is the package manager for the open agent skills ecosystem. Skills are modular packages that extend Claude Code capabilities with specialized knowledge, workflows, and tools.
