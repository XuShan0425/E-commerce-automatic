...
- `.codex-runs/EPIC-XXX/integration-plan.md`
- `.codex-runs/EPIC-XXX/integration-verification.md`
- `docs/exec-plans/completed/EPIC-XXX.md` only after successful integration
