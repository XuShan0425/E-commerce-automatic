---
name: agent-planner
description: Use when the user gives a high-level product or engineering requirement and wants Claude Code to clarify, plan, split into EPIC/TASK files, and not implement code yet.
---
...
- `docs/exec-plans/active/TASK-XXX.md` (individual task breakdown)

Use the `TaskCreate` tool to track implementation progress. Use `EnterPlanMode` before writing implementation code.
